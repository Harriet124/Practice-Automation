describe("Template Spec", () => {
  ...
  it("should set up the input fields and validate their state", () => { // Setup for this specific test cy.visit("https://letcode.in/test"); 
    ...
    cy.get("#join").type("Hey Bene, Welcome"); cy.get("#getMe").type("ortonikc"); cy.get("#clearMe").clear(); cy.get("#noEdit").should("be.disabled"); cy.get("#dontwrite").should("have.attr", "readonly"); });
