describe("Template Spec", () => {
  ...
  it("should test the frame functionality", () => {
    ...
    // Add more code here to interact with elements within the frame
    // For example:
    // cy.frameLoaded('#frameId'); // Load the frame
    // cy.iframe().find('#someElement').click(); // Interact with elements within the frame
  });
});
