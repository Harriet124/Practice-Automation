describe("Template Spec", () => {
  ...
  it.only("should set up the input fields and validate their state", () => {
  ...
  it("should test the alert functionality"), () =>{
       cy.get("#accept").click();y.visit("https://letcode.in/alert");y.get("#confirm").click();y.visit("https://letcode.in/alert");y.window().then((win) => { cy.stub(win, "prompt").returns("Chris"); cy.get("#prompt").click(); cy.get(".notification.is-info").should("have.text", "Your name is: Ama"););
  });
