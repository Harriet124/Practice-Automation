describe("Template Spec", () => {
  ...
  it("should test the button", () => {
    cy.xpath("//a[normalize-space()='Click']").click(); // Added .click() here
    cy.get("#home").click();
  ...
  it.only("should test the select functionality", () => {
    cy.xpath("//a[normalize-space()='Drop-Down']").click(); // Added .click() here
  ...
  it("should test the alert functionality", () => { // Corrected syntax here
